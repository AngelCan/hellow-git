...
| ------ | -------- | --------- |
| maxi | burgos | matrimonio |
| tomas | tomson | defuncion |

# Citas
Esto es un texto referente a una cita que se pondrá debajo 
> esto es una cita 

Esto es otro texto que no se relaciona con la cita anterior:
> esto es otra cita

Siempre se hace un espacio de separacion o el otro texto se incluira en la cita
...
esto es otra manera de dividir el texto
